                            ...
                            <div class="col-xl-4 col-md-5 col-sm-7 send-invoice invoice">
                                <div class="bill-timeline-inner d-flex flex-column text-center">
                                    ...
                                    <div class="timeline-content flex-1">
                                        ...
                                        @if($bill->status==0)
                                            @can('send bill')
                                                <a href="{{ route('bill.sent',$bill->id) }}" class="btn btn-sm d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-original-title="{{__('Mark Sent')}}"><i class="ti ti-send"></i>{{__('Send')}}</a>
                                            @endcan
                                        @endif
                                    </div>
                                </div>
