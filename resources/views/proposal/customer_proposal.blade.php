...
@endphp
 ...
 <head>
   ...
   <title>{{(Utility::companyData($proposal->created_by,'title_text')) ? Utility::companyData($proposal->created_by,'title_text') : config('app.name', 'Agency soul')}} - {{__('Proposal')}}</title>
